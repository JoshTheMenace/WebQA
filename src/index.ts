    ...
    tools: [
      {
        ...
        description:
          'Execute a browser test using JSON DSL. Launches a Chromium browser, runs the specified test steps, and records a video of the session. Returns detailed results including pass/fail status, step results, and video path.',
